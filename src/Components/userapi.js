...
My conclusion : Quantum physics challenges the concept of classical physics as classical physics can not give a proper explanation for Quantum. Challenges often open new doors, new perspectives. I’m still not thinking about you, but are we gonna end up with a Quantum Decoherence affected by noises of our environment or work on solving the calculations so we can get the Quantum Supermacy?`        
    },
    {
        ...
        We weren’t meant to part, tho. We just didn’t have the gut to stick and fight, to face the reality of our mistakes and correct, to step out of our overconfident self and be confident. So yes, we are going back to the start. The start of our dreams that reached the skies. But this time we know it’s not easy. We learned it is so hard to be apart.
...
Remember the key is practice and more practice. With more practice you will definitely get the score you’re looking for. I wish you Good Luck from now.
        `
    },
